local cyberdream_bright_blue = {
  normal = {
    a = { fg = '#0f0f0f', bg = '#00bfff', gui = 'bold' },    -- DeepSkyBlue
    b = { fg = '#c0c0c0', bg = '#005f87' },
    c = { fg = '#b3b3b3', bg = '#1a1a1a' },
  },
  insert = {
    a = { fg = '#0f0f0f', bg = '#40e0d0', gui = 'bold' },    -- Turquoise
    b = { fg = '#c0c0c0', bg = '#008080' },
    c = { fg = '#b3b3b3', bg = '#1a1a1a' },
  },
  visual = {
    a = { fg = '#0f0f0f', bg = '#00ced1', gui = 'bold' },    -- DarkTurquoise
    b = { fg = '#c0c0c0', bg = '#006666' },
    c = { fg = '#b3b3b3', bg = '#1a1a1a' },
  },
  replace = {
    a = { fg = '#0f0f0f', bg = '#1e90ff', gui = 'bold' },    -- DodgerBlue
    b = { fg = '#c0c0c0', bg = '#004080' },
    c = { fg = '#b3b3b3', bg = '#1a1a1a' },
  },
  command = {
    a = { fg = '#0f0f0f', bg = '#00bfff', gui = 'bold' },    -- DeepSkyBlue (same as normal)
    b = { fg = '#c0c0c0', bg = '#005f87' },
    c = { fg = '#b3b3b3', bg = '#1a1a1a' },
  },
}
